...
export default {
  ...
  services: {
    manicure: [
      ...
      service("Маникюр всё включено\n(выравнивание, укрепление гелем)", "от 3 500 ₽", "1 ч 30 мин"),
      ...
      service("Покрытие ногтей лаком\n(без маникюра)", "от 1 200 ₽", "20 мин"),
    ...
    pedicure: [
      ...
      service("Педикюр детский\n(обработка ногтей)", "от 1 000 ₽", "30 мин"),
      service("Педикюр комби/аппаратный без покрытия", "от 3 200 ₽", "1 ч"),
      service("Педикюр комби/аппаратный + гель-лак\n(всё включено)", "от 4 000 ₽", "1 ч 30 мин"),
      service("Педикюр комби/аппаратный с покрытием гель-лак\n(пальчики)", "от 3 000 ₽", "1 ч"),
  ...
  amenities: [
    ...
    { title: "Большая палитра", text: "Много оттенков и вариантов дизайнов" },
    { title: "Обучение мастеров", text: "Индивидуальные занятия и курсы" },
  ],
